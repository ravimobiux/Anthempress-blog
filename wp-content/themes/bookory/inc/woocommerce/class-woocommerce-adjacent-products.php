<?php
/**
 * Bookory WooCommerce Adjacent Products Class
 *
 * @package  bookory
 * @since    2.4.3
 */
...
if ( ! class_exists( 'Bookory_WooCommerce_Adjacent_Products' ) ) :

	/**
	 * The Bookory WooCommerce Adjacent Products Class
	 */
	class Bookory_WooCommerce_Adjacent_Products {
		...
		private function query_wc() {
			...
			$products = wc_get_products( apply_filters( 'bookory_woocommerce_adjacent_query_args', $args ) );
