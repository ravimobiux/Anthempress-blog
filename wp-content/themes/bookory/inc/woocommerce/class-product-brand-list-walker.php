<?php
/**
 * Bookory_Product_Brand_List_Walker class
 *
 * @extends    Walker
 * @class        Bookory_Product_Brand_List_Walker
 * @version        2.3.0
...
if (!class_exists('Bookory_Product_Brand_List_Walker', false)) :

	class Bookory_Product_Brand_List_Walker extends Walker {
