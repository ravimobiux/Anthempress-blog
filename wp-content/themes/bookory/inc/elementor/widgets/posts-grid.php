...
/**
 * Class Bookory_Elementor_Blog
 */
class Bookory_Elementor_Post_Grid extends Elementor\Widget_Base {

    public function get_name() {
        return 'bookory-post-grid';
    }

    public function get_title() {
        return esc_html__('Posts Grid', 'bookory');
    }
    ...
    public function get_script_depends() {
        return ['bookory-elementor-posts-grid', 'slick'];
    }
    ...
    protected function register_controls() {
        $this->start_controls_section(
            'section_query',
            [
                'label' => esc_html__('Query', 'bookory'),
        ...
        $this->add_control(
            ...
            [
                ...
                'default' => 'post_date',
                'options' => [
                    'post_date'  => esc_html__('Date', 'bookory'),
                    'post_title' => esc_html__('Title', 'bookory'),
        ...
        $this->add_control(
            'tag_operator',
            [
                'label'     => esc_html__('Tags Operator', 'bookory'),
                'type'      => Controls_Manager::SELECT,
                'default'   => 'IN',
                'options'   => [
                    'AND'    => esc_html__('AND', 'bookory'),
        ...
        $this->add_control(
            ...
            [
                ...
                'type'    => \Elementor\Controls_Manager::SELECT,
                'options' => [
                    'post-style-1' => esc_html__('Blog Grid', 'bookory'),
                    'post-style-2' => esc_html__('Blog special', 'bookory'),
                ],
        ...
        $this->start_controls_section(
            'section_pagination',
            [
                'label' => esc_html__('Pagination', 'bookory'),
            ]
        ...
        $this->add_control(
            ...
            [
                ...
                'default' => '',
                'options' => [
                    ''                      => esc_html__('None', 'bookory'),
                    'numbers'               => esc_html__('Numbers', 'bookory'),
                    'prev_next'             => esc_html__('Previous/Next', 'bookory'),
                    'numbers_and_prev_next' => esc_html__('Numbers', 'bookory') . ' + ' . esc_html__('Previous/Next', 'bookory'),
                ],
            ]
        );
        ...
        $this->add_control(
            ...
            [
                'label'     => esc_html__('Page Limit', 'bookory'),
                'default'   => '5',
                'condition' => [
                    'pagination_type!' => '',
                ],
        ...
        $this->add_control(
            ...
            [
                'label'     => esc_html__('Shorten', 'bookory'),
        ...
        $this->add_control(
            ...
            [
                'label'     => esc_html__('Previous Label', 'bookory'),
                'default'   => esc_html__('&laquo; Previous', 'bookory'),
                'condition' => [
                    'pagination_type' => [
                        'prev_next',
                        'numbers_and_prev_next',
        ...
        $this->add_control(
            ...
            [
                'label'     => esc_html__('Next Label', 'bookory'),
                'default'   => esc_html__('Next &raquo;', 'bookory'),
                'condition' => [
                    'pagination_type' => [
                        'prev_next',
                        'numbers_and_prev_next',
    ...
    protected function render_loop_footer() {
        ...
        if ($has_numbers) {
            $links = paginate_links([
                ...
                'before_page_number' => '<span class="elementor-screen-only">' . esc_html__('Page', 'bookory') . '</span>',
            ]);
        }
        ...
        <div class="pagination">
            <nav class="elementor-pagination" role="navigation"
                 aria-label="<?php esc_attr_e('Pagination', 'bookory'); ?>">
...
$widgets_manager->register(new Bookory_Elementor_Post_Grid());
